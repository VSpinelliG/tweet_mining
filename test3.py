...
with open('bolsonaro_colocar_sentimento4.csv', encoding='utf-8') as csvfile:
...
with open('bolsonaro_colocar_sentimento41.csv', mode='w', encoding='utf-8', newline='') as csvfile:
