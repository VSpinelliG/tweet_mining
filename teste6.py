...
with open('bolsonaro_colocar_sentimento7.csv', encoding='utf-8') as csvfile:
...
with open('bolsonaro_colocar_sentimento71.csv', mode='w', encoding='utf-8', newline='') as csvfile:
