...
exibir_resultado( analisar_frase(classificador, vetorizador,"bolsonaro deu show o resto é churumela e um palocci bem no meio da sua cara horrorosa"))
exibir_resultado( analisar_frase(classificador, vetorizador,"bolsonaro realiza um discurso cheio de ódio lançando ataques aos seus antecessores perdeu grande oportunidade de construir pontes para o progresso"))
