...
with open('bolsonaro_colocar_sentimento5.csv', encoding='utf-8') as csvfile:
...
with open('bolsonaro_colocar_sentimento51.csv', mode='w', encoding='utf-8', newline='') as csvfile:
