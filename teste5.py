...
with open('bolsonaro_colocar_sentimento6.csv', encoding='utf-8') as csvfile:
...
with open('bolsonaro_colocar_sentimento61.csv', mode='w', encoding='utf-8', newline='') as csvfile:
